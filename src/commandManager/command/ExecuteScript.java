...
public class ExecuteScript implements Command {
    ...
    private void addOrganization(String[] tokens) {
        ...
        if (tokens.length >= 8) {
            ...
            Integer coordinateX = Integer.parseInt(tokens[3]);
            Integer coordinateY = Integer.parseInt(tokens[4]);
            Coordinates coordinates = new Coordinates(coordinateX, coordinateY);
            Integer annualTurnover = Integer.parseInt(tokens[5]);
            int orgType = Integer.parseInt(tokens[6]);
            ...
            Organization organization = new Organization(name, id, coordinates, address, annualTurnover, type);
